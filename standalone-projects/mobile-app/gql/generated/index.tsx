...
export type ManufacturersQuery = { __typename?: 'Query', manufacturers: Array<{ __typename?: 'Manufacturer', id: string, manufacturedCount: number, soldCount: number, returnedCount: number, createdAt: any }>, manufacturersCount: { __typename?: 'AggregateCountOutput', count: number } };
...
export type ProductsQuery = { __typename?: 'Query', products?: Array<{ __typename?: 'Product', id: string, name: string, plasticWeight: number, quantity: number, createdAt: any, updatedAt: any, manufacturerId: string, returnedCount: number, soldCount: number }> | null, productsCount: { __typename?: 'AggregateCountOutput', count: number } };

export type TransactionsQueryVariables = Exact<{
  distinct?: InputMaybe<Array<TransactionScalarFieldEnum> | TransactionScalarFieldEnum>;
  skip?: InputMaybe<Scalars['Int']>;
  take?: InputMaybe<Scalars['Int']>;
  cursor?: InputMaybe<TransactionWhereUniqueInput>;
  orderBy?: InputMaybe<Array<TransactionOrderByWithRelationInput> | TransactionOrderByWithRelationInput>;
  where?: InputMaybe<TransactionWhereInput>;
}>;


export type TransactionsQuery = { __typename?: 'Query', transactions?: Array<{ __typename?: 'Transaction', createdAt: any, id: number, productItemId: string, status?: Status | null, productItem: { __typename?: 'ProductItem', product: { __typename?: 'Product', name: string } } }> | null, transactionsCount: { __typename?: 'AggregateCountOutput', count: number } };
...
export const ProductsDocument = /*#__PURE__*/ gql`
    query products($distinct: [ProductScalarFieldEnum!], $skip: Int, $take: Int, $cursor: ProductWhereUniqueInput, $orderBy: [ProductOrderByWithRelationInput!], $where: ProductWhereInput) {
  products(
    distinct: $distinct
    skip: $skip
    take: $take
...
export const TransactionsDocument = /*#__PURE__*/ gql`
    query Transactions($distinct: [TransactionScalarFieldEnum!], $skip: Int, $take: Int, $cursor: TransactionWhereUniqueInput, $orderBy: [TransactionOrderByWithRelationInput!], $where: TransactionWhereInput) {
  transactions(
    distinct: $distinct
    skip: $skip
    take: $take
